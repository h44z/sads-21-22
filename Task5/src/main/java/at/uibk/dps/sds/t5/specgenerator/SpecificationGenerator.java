package at.uibk.dps.sds.t5.specgenerator;
...
public class SpecificationGenerator implements SpecificationWrapper {
	...
	protected final double mttfMeanRes;
	protected final double mttfDevRes;
	protected final double mttfMeanLink;
	protected final double mttfDevLink;
	protected final double mttfMeanTask;
	protected final double mttfDevTask;
	...
	public SpecificationGenerator(
			...
			@Constant(value = "mttfMeanRes", namespace = SpecificationGenerator.class) double mttfMeanRes,
			@Constant(value = "mttfDevRes", namespace = SpecificationGenerator.class) double mttfDevRes,
			@Constant(value = "mttfMeanLink", namespace = SpecificationGenerator.class) double mttfMeanLink,
			@Constant(value = "mttfDevLink", namespace = SpecificationGenerator.class) double mttfDevLink,
			@Constant(value = "mttfMeanTask", namespace = SpecificationGenerator.class) double mttfMeanTask,
			@Constant(value = "mttfDevTask", namespace = SpecificationGenerator.class) double mttfDevTask, Rand rand) {
		this.rand = rand;
		this.secrecy = secrecy;
		this.mttfDevRes = mttfDevRes;
		this.mttfMeanRes = mttfMeanRes;
	...
	protected Architecture<Resource, Link> generateArchitecture(int numEdgeClusters, int numCloudClusters,
		...
		PropertyService.setReliabilityAverage(internetNode, mttfMeanRes);
		PropertyService.setReliabilityDeviation(internetNode, mttfDevRes);
	...
	protected Task createTask() {
		...
		PropertyService.setReliabilityAverage(result, mttfMeanTask);
		PropertyService.setReliabilityDeviation(result, mttfDevTask);
		return result;
	}
	...
	protected Resource createRes() {
		Resource result = new Resource("r" + resNum++);
		PropertyService.setReliabilityAverage(result, mttfMeanRes);
		PropertyService.setReliabilityDeviation(result, mttfDevRes);
		return result;
	}

	protected Link createLink() {
		Link result = new Link("l" + linkNum++);
		PropertyService.setReliabilityAverage(result, mttfMeanLink);
		PropertyService.setReliabilityDeviation(result, mttfDevLink);
		return result;
	}
